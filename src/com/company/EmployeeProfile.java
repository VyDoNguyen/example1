...
public class EmployeeProfile {
        ...
        public static void employeeLogin() {
            ...
            while(!validLogin) {
                ...
                if (theEmployeeUserName.equals("gregford12")==true && employeePassword.equals("Password1000")==true) {
                    System.out.println("account found");
                    validLogin = true;
                    return;
                }
                if (theEmployeeUserName.equals("gregford12")!=true || theUserPassword.equals("Password1000")!=true){
                    System.out.println("account not found or incorrect login");
                }
